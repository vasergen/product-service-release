...
printf "!!!![DEBUG] MONGODB_HOST_PRODUCTION: %s\n" "$MONGODB_HOST_PRODUCTION"
printf "!!!![DEBUG] MONGODB_HOST_STAGE: %s\n" "$MONGODB_HOST_STAGE"
...
MONGODB_CONNECTION_STRING_PRODUCTION_WITH_AUTH="mongodb+srv://$MONGODB_USER_NAME:$MONGODB_PASSWORD_PRODUCTION@$MONGODB_HOST_PRODUCTION/$PROD_PASSIVE_DB"

printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_STAGE_WITH_AUTH: %s\n" "$MONGODB_CONNECTION_STRING_STAGE_WITH_AUTH"
printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_PRODUCTION_WITH_AUTH: %s\n" "$MONGODB_CONNECTION_STRING_PRODUCTION_WITH_AUTH"
