...
printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_STAGE BEFORE: %s\n" "$MONGODB_CONNECTION_STRING_STAGE"
printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_PRODUCTION BEFORE: %s\n" "$MONGODB_CONNECTION_STRING_PRODUCTION"
...
printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_STAGE AFTER: %s\n" "$MONGODB_CONNECTION_STRING_STAGE"
printf "!!!![DEBUG] MONGODB_CONNECTION_STRING_PRODUCTION AFTER: %s\n" "$MONGODB_CONNECTION_STRING_PRODUCTION"
